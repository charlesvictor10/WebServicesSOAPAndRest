...
public class BanqueWSLocator extends org.apache.axis.client.Service implements com.youssfi.service.BanqueWS {
    ...
    private java.lang.String BanqueServicePort_address = "http://localhost:8080/";
    ...
    public com.youssfi.service.BanqueService getBanqueServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.youssfi.service.BanqueService getBanqueServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.youssfi.service.BanqueServicePortBindingStub _stub = new com.youssfi.service.BanqueServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.youssfi.service.BanqueService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.youssfi.service.BanqueServicePortBindingStub _stub = new com.youssfi.service.BanqueServicePortBindingStub(new java.net.URL(BanqueServicePort_address), this);
                _stub.setPortName(getBanqueServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.youssfi.com/", "BanqueWS");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.youssfi.com/", "BanqueServicePort"));
        }
