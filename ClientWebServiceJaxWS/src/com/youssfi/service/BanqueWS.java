 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://service.youssfi.com/", wsdlLocation = "http://localhost:8080/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://service.youssfi.com/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://service.youssfi.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.youssfi.com/", "BanqueServicePort"), BanqueService.class, features);
    }
