 ...
 * generated in the com.youssfi.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _ConversionEuroToDh_QNAME = new QName("http://service.youssfi.com/", "ConversionEuroToDh");
    private final static QName _GetCompte_QNAME = new QName("http://service.youssfi.com/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://service.youssfi.com/", "getCompteResponse");
    private final static QName _GetComptes_QNAME = new QName("http://service.youssfi.com/", "getComptes");
    private final static QName _Compte_QNAME = new QName("http://service.youssfi.com/", "compte");
    private final static QName _GetComptesResponse_QNAME = new QName("http://service.youssfi.com/", "getComptesResponse");
    private final static QName _ConversionEuroToDhResponse_QNAME = new QName("http://service.youssfi.com/", "ConversionEuroToDhResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.youssfi.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.youssfi.com/", name = "ConversionEuroToDh")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.youssfi.com/", name = "getCompte")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.youssfi.com/", name = "getCompteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.youssfi.com/", name = "getComptes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.youssfi.com/", name = "compte")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.youssfi.com/", name = "getComptesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.youssfi.com/", name = "ConversionEuroToDhResponse")
